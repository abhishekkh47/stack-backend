...
export const SYSTEM_DATA =
  '“dataset1” below contains a list of business descriptions, the corresponding category of that business and the problem that business solves.\nI want you to write a business description that closely follows the format of the business descriptions in “dataset1" and based on each idea generated, output the market size. - create a valid JSON array of objects for business descriptions and related opportunity following this format:\n[{"businessDescription": "An AI-powered local event finding app, tailored to provide real-time updates on exclusive local events.","opportunityHighlight": "Local entertainment market $10Bn+"}].\nThese are all one sentence, short but unique businesses.\nYou will output three different business descriptions based on the category and problem from user input.\n\ndataset1:\nA gamified and story-driven application teaching coding in Python, HTML, CSS, or JavaScript.\tOnline Gaming\tBalancing gaming with other life responsibilities.\nAn AI shopping assistant integrated into e-commerce platforms to personalize customer shopping experiences.\tSizing\tDifficulty finding consistent sizing across brands.\nA LinkedIn post generator optimizing posts for audience engagement and personal branding.\tSocial Media\tManaging personal reputation or brand.\nA mobile app providing theft protection, insurance, roadside assistance, and on-demand repairs for e-bike owners.\tOutdoor Adventure/Sports\tExperiencing equipment or gear issues.\nA digital Bitcoin art marketplace leveraging smart contracts and the Lightning Network for digital art asset exchanges.\tCryptocurrency\tAccessing and analyzing public blockchain data.\nA virtual poker app designed for friend groups, featuring chat and video interfaces for a social gaming experience.\tOnline Gaming\tBuilding a team in cooperative games.\nA text-to-audio app utilizing AI to customize human-like emotions in audio content.\tMaking Music\tLearning music production software.\nA travel credit card tailored to the unique needs of Generation Z.\tLuxury Travel\tPersonalized itinerary planning.\nA brokerage firm enabling users to build custom ETFs based on their investment preferences and risk profile.\tTrading Stocks\t  Experiencing volatility due to inadequate risk management.\nA voice-to-action AI agent acting as a personal assistant, managing administrative tasks and life organization.\tFinancial Literacy\tManaging credit and debt.\nA fintech platform allowing Mexican nationals to earn US Dollars and pay in Mexican Pesos.\tFinancial Literacy\tUnderstanding cryptocurrency and digital assets.\nA marketplace streamlining the acquisition and transaction process of small businesses.\tTrading Stocks\tLosing money by following online communities/posts.\nA marketplace for rare coins and precious metals, using auction data and historical pricing for accurate valuations.\tCryptocurrency\tVolatility in web3 assets like NFTs.\nAn AI-driven shopping platform where users can find clothing items based on inputted styles or looks.\tFast Fashion\tIdentifying sustainably made products.\nAn AI-driven video game designer generating new maps, terrains, and resources for unpredictable gameplay.\tOnline Gaming\tLack of innovation in majority of games.\nA platform identifying the best plane ticket deals using exclusively credit card points.\tBudget Travel\tFinding affordable eating options.\nAn AI-driven news content writer focusing on niche current events for cost-effective article creation.\tWriting\tFinding inspiration.\nAn app leveraging AI to create and share photos of users in imaginary situations on social media.\tSocial Media\tAvoiding content or creation burnout.\nAn AI-driven math tutor incorporating speech, text, and image recognition for personalized learning.\tEducation\tFinding effective learning strategies.\nAn AI-driven marketplace offering back-office tasks like lead generation or financial modeling at competitive prices.\tFinancial Literacy\tGrasping financial regulation and legal practices.\nAn AI and gamified nutrition coach allowing meal logging through photo recognition.\tHealth & Nutrition\tCreating balanced and nutritious meals.\nAn AI-driven video animation creator transforming text inputs into short-form animations.\tVideography\tTime-consuming editing process.\nA multiplayer development platform providing game servers, matchmaking, and DDoS mitigation.\tOnline Gaming\tEnsuring fair play and dealing with cheaters.\nAn AI search engine for academic research, answering questions with included citations.\tEducation\tAccessing diverse educational resources.\nA mobile application optimizing app usage time for mental health benefits.\tMental Health\tManaging screen time effectively.\nAn AI-driven comic creator instantly generating comics from text inputs.\tDrawing/Painting\tOvercoming creative block.\nA marketplace for real-life events, using AI to optimize and personalize event suggestions.\tFestivals/Concerts\tLocating concerts and festivals.\nA mobile app enforcing habits through monetary wagers.\tMental Health\tBuilding positive habits and routines.\nA social app for creators, educators, and experts to launch video courses and provide AI-assisted coaching.\tEducation\tAccessing diverse educational resources.\nA marketplace offering curated real-life guides and adventures globally for trip planning.\tAdventure\tDifficulty finding travel buddies for niche adventures.\nA text-to-video language model converting text inputs into visually rich short-form videos.\tVideography\tGenerating engaging and original content ideas.\nA self-custody bitcoin app catering to users wary of crypto exchanges and hardware wallets.\tCryptocurrency\tSecurity breaches in accounts/wallets.\nA Fintech platform enabling investment in company earnings, revenues, regions, and segments without buying stocks.\tTrading Stocks\tIncurring losses from borrowing/margin trading.\nA digital wealth management platform offering access to actively managed alternative investment portfolios.\tFinancial Literacy\tLearning about stock trading and investing.\nAn all-in-one fintech platform providing bank accounts, transfers, credit cards, and financial data for e-commerce businesses.\tFinancial Literacy\tOptimizing financial infrastructure.\nA reseller marketplace for second-hand fashion using live streaming and video marketing.\tFast Fashion\tInfluencer-led promotions and follower mentality.\nAn AI-driven picture-to-purchase e-commerce tool converting online images into purchase links.\tOnline Shopping\tFinding quality products at affordable prices.\nAn accelerator program focused on Roblox games.\tOnline Gaming\tBuilding a team in cooperative games.\nAn AI-driven dating matchmaker emphasizing depth by limiting engagement to one user at a time.\tOnline Dating\tOverwhelmed by choices.\nA virtual reality basketball game where players team up to defeat non-player characters.\tVirtual Reality Games\tLimited social interaction in VR gaming.\nA food manufacturer specializing in sustainable seafood alternatives using plant protein and biotechnology.\tConservation/Environmentalism\tHabitat destruction and fragmentation.\nA cat food manufacturer incorporating plant protein for more sustainable animal food.\tConservation/Environmentalism\tConflict with local communities or businesses.\nAn AI-driven website builder converting text prompts into functional landing pages and websites.\tTechnology\tNavigating website design and development.\nA commission-free sports betting exchange for bets against peers rather than the house.\tFantasy/Betting\tKeeping fantasy league participation within budget.\nA group rideshare app offering on-demand 15-passenger van bookings for consumers and businesses.\tTransportation\tFinding affordable and reliable travel options.\nAn AI-driven fitness app providing personalized coaching for runners.\tFitness/Working Out\tDeveloping a personalized nutrition plan.\nA fintech app for contractors and freelancers to transact using an exclusive digital currency.\tCryptocurrency\tIdentifying scams and fraud schemes.\nA mobile app assisting consumers with low credit scores in credit recovery through personalized plans.\tFinancial Literacy\tManaging credit and debt.\nA fintech mobile app automating savings and investing them in gold.\tBudgeting/Saving\tSetting and achieving financial goals.\n\n';
